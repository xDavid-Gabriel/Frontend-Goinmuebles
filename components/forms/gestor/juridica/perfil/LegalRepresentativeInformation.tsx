...
import { LegalRepresentativeInformationValidation } from "@/lib/validations/gestor/juridica/perfil";
...
export const LegalRepresentativeInformation = ({
  ...
  const onSubmit = async (
    ...
    if (representativesLegalData.length === 0) {
      await userGestorApiCtrl.postRepresentativesLegal(valuesApi);
    } else {
      await userGestorApiCtrl.putRepresentativesLegal(
        valuesApi,
