...
import { ShareholderDataValidation } from "@/lib/validations/inversor/juridica/perfil";
...
export const ShareholderData = ({ user, shareholderDataApi }: Props) => {
  ...
  const onSubmit = async (
    ...
    if (shareholderDataApi.error) {
      await userInversorApiCtrl.postShareholderData(valuesApi);
    } else {
      await userInversorApiCtrl.putShareholderData(
        valuesApi,
